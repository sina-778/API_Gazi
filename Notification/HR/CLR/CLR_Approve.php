...
function postMethod($requestData)
{
    ...
    $xpdreqnum=$requestData["xpdreqnum"];
    $ypd = 0;
    $xstatusreq=$requestData["xstatusreq"];
    $approvalType = 'Employee Requisition Approval';
    ...
    try {
        ...
        $stmt->bindParam(4, $xpdreqnum, PDO::PARAM_STR);
        $stmt->bindParam(5, $ypd, PDO::PARAM_INT);
        $stmt->bindParam(6, $xstatusreq, PDO::PARAM_STR);
