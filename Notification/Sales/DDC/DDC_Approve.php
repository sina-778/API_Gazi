...
function postMethod($requestData)
{
    ...
    $approvalType = 'Short_Excess DC Approval';

    $sql = "EXEC zabsp_apvprcs ?, ?, ?, ?, ?, ?, ?";  //temp = #spsql(zabsp_apvprcs,#id,#user,#position,xdocnum,0,xstatus1,"Short_Excess DC Approval")
    ...
    try {
        ...
        $stmt->bindParam(4, $xdocnum, PDO::PARAM_STR);
