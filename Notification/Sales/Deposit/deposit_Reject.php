...
function postMethod($requestData)
{
    ...
    // set temp =#sesql("update ardeposit set xnote1 ='"+xnote1+"' where zid='"+#id+"' and xdepositnum='"+xdepositnum+"'")
    // set temp =  #spsql(zabsp_Reject_Request,#id,#user,#position,0,xdepositnum,"Deposit Approval")

    $sql = "UPDATE ardeposit SET xnote1 = :xnote WHERE xdepositnum = :xdepositnum and zid = :zid ";
    ...
    try {
        ...
        $stmt1->bindParam(5, $xdepositnum, PDO::PARAM_STR);
