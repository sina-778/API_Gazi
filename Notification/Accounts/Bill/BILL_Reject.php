...
function postMethod($requestData)
{
    ...
    $approvalType = 'Bill Reject';

    $sql = "UPDATE acbill SET xnote1 = :xnote WHERE xbillno = :xbillno and zid = :zid";

    try {
        $stmt = $conn->prepare($sql);
        $stmt->bindParam(':xnote', $xnote, PDO::PARAM_STR);
        $stmt->bindParam(':xbillno', $xbillno, PDO::PARAM_STR);
        ...
        $stmt1->bindParam(5, $xbillno, PDO::PARAM_STR);
