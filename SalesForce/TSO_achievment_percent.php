...
function getmethod(){
	...
	$sql = "select(( select isnull(sum((isnull(d.xqtydoc*isnull(a.xpackqty,0),0)/1000)),0) as tso_sales
	...
	where h.xtso='$xtso'  and h.xstatusdoc='Confirmed' and  month(h.xdate)='$mothth_per' and year(h.xdate)='$xyear' ) /(select sum(td.xdphqty) from optargetheader th join optargetdetail td on th.zid=td.zid and th.xcus=td.xcus 
	and th.xper=td.xper and th.xyear=td.xyear where th.xtso='$xtso' and th.xper='$mothth_per' and th.xyear='$xyear') )*100 as achv_percent";
